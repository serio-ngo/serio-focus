...
export const webCap = (raw = process.env.HANDOFF_WEB_CAP) => positive(raw, WEB_CALLS);export const delegateOn = (raw = process.env.HANDOFF_DELEGATE) => String(raw ?? '1').trim() !== '0';
